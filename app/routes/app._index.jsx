...
function CostEstimator({ avgCostPerMessage, totalMessages }) {
  ...
  return (
    <section className="seos-card seos-calc" aria-label="AI cost estimator">
      <div className="seos-calc-grid">
        <div className="seos-calc-controls">
          <div>
            <div className="seos-card-title">Cost estimator</div>
            <div className="seos-card-desc">
  ...
  return (
    <Page>
      ...
      <style>{`
        ...
        /* Cost estimator — full-width interactive card below Explore.
           Left: three controls (sessions, engagement slider, depth).
           Right: a quiet green result panel with the live figure. It's
           a form, not a link, so the card-hover lift is switched off. */
        .seos-calc { cursor: default; }
        .seos-calc:hover {
          transform: none;
      ...
      <div className="seos-home">
        ...
        <BlockStack gap="500">
          ...
          <CostEstimator avgCostPerMessage={avgCostPerMessage} totalMessages={totalMessages} />
