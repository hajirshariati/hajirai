...
export function buildSystemPrompt({ config, knowledge, shop, attributeNames }) {
  ...
  parts.push(
    [
      ...
      "- ABSOLUTE RULE: Your response must NEVER start with or contain 'Let me', 'I'll find', 'I'll search', 'I'll look', 'I'll check', 'Let me find', 'Let me get', 'Let me pull up', 'right away', 'one moment'. These phrases are BANNED. Instead, jump straight to the answer or recommendation. BAD: 'Let me find the right orthotic for you.' GOOD: 'Based on your arch pain, the L720 Casual Posted Orthotic is a great fit!' The customer doesn't need to know you searched — just give them the result.",
