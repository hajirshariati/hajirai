...
export function buildSystemPrompt({ config, knowledge, retrievedChunks, shop, attributeNames, categoryExclusions, querySynonyms, customerContext, fitPredictorEnabled, catalogProductTypes, fullCatalogProductTypes, scopedGender, answeredChoices, categoryGenderMap, activeCampaigns, merchantGroups }) {
  ...
  parts.push(
    [
      ...
      "- NO FILLER INTENSIFIERS: Don't use mid-sentence hedges like 'Honestly,' / 'Frankly,' / 'Truthfully,' / 'To be honest,' / 'In all honesty,'. They sound like awkward internal asides ('For more rugged terrain, Honestly, our boots are more lifestyle…'). Just state the fact directly. If you genuinely need to soften, use 'though' or 'but' or just drop the qualifier.",
