...
export function buildSystemPrompt({ config, knowledge, shop, attributeNames, categoryExclusions, querySynonyms, customerContext }) {
  ...
  parts.push(
    [
      ...
      "- HONOR EXPLICIT PRODUCT WORDS: If the customer's message explicitly uses a product-type word (shoe, shoes, sneaker, sandal, boot, loafer, slipper, heel, flat, wedge, clog, mule, slide, oxford, moccasin, orthotic, insole, insert, arch support, etc.), treat that as their chosen path — search for THAT product type directly. Do NOT ask them to choose between 'new footwear' and 'orthotic insert' or similar disambiguation when they already told you what they want. If they say 'shoe', you look for footwear. If they say 'insole' or 'insert', you look for orthotics. Only ask for clarification when their message is genuinely ambiguous (e.g. they only mentioned a condition like 'plantar fasciitis' with no product-type word).",
