...
export function buildSystemPrompt({ config, knowledge, shop, attributeNames, categoryExclusions, querySynonyms, customerContext, fitPredictorEnabled, catalogProductTypes, scopedGender }) {
  ...
  parts.push(
    [
      ...
      "- NO ECHO HEADLINE: When showing products, write ONE opening sentence — not a headline plus a body that repeats it. If you mention a category, gender, or feature in your opening line, the next sentence must add NEW information without re-stating the same phrasing. FORBIDDEN: \"Here are some great women's wedges! Here are some great women's wedges with arch support.\" CORRECT: \"Here are some great women's wedges with arch support and memory foam — built for foot pain.\" One sentence, no echo. If you have nothing new to add after the opener, stop after the opener.",
    ].join("\n"),
  );
