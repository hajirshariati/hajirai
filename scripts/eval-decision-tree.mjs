...
// product. Unisex (which means "adult unisex" in this catalog) is
// NOT acceptable for a child. If no Kids SKU exists for the asked
// use-case, the resolver returns null so the caller can tell the
// customer honestly that we don't carry a kids product for it.
