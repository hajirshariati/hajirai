  ...
  ==============================================================================*/
        ...
        Updater: (function () {
            class Updater {
                ...
                on(element) {
                    ...
                    element.addEventListener("scroll", this.cb, { passive: true });
    ...
    theme.RevealButton = (function () {
        ...
        class RevealButton {
            ...
            onLeaveHandler() {
                if (this.btnReveal) {
                    Motion.animate(this.btnReveal, {x: 0, y: 0, opacity: 0}, {
                        duration: 0.2,
    ...
    theme.Animation = (function () {
        class Animation {
            ...
            async load() {
                ...
                switch (this.type) {
                    case 'fade-in':
                        await Motion.animate(this.container, {opacity: 1}, {
                            duration: 1.5,
                            delay: this.delay,
                            easing: [0.16, 1, 0.3, 1]
                        }).finished;
                    ...
                    case 'fade-up':
                        await Motion.animate(this.container, {transform: 'translateY(0)', opacity: 1}, {
                            duration: 1.5,
                            delay: this.delay,
                            easing: [0.16, 1, 0.3, 1]
                        }).finished;
                    ...
                    case 'zoom-out':
                        await Motion.animate(this.container, {transform: 'scale(1)'}, {
                            duration: 1.3,
                            delay: this.delay,
                            easing: [0.16, 1, 0.3, 1]
                        }).finished;
            ...
            async reset(duration) {
                ...
                switch (this.type) {
                    case 'fade-in':
                        await Motion.animate(this.container, {opacity: 0}, {
                    ...
                    case 'fade-up':
                        await Motion.animate(this.container, {
                            transform: 'translateY(max(-2rem, -90%))',
                            opacity: 0
                        }, {
                            duration: duration ? duration : 1.5,
                            delay: this.delay,
                    ...
                    case 'zoom-out':
                        await Motion.animate(this.container, {transform: 'scale(0)'}, {
...
class HoverButton extends HTMLButtonElement {
    ...
    async attributeChangedCallback(name, oldValue, newValue) {
        if (newValue === 'true') {
            ...
            Motion.animate(this.animationElement.children, {transform: ['scale(1.6)', 'scale(0.6)']}, {
                duration: 0.35,
...
class AnnouncementBar extends HTMLElement {
    ...
    init() {
        ...
        if (this.items.length > 1) {
            ...
            // custom code to hide arrow of the slider when < 1 slide starts
            const prevBtn = document.getElementById("custom-previous-button");
            const nextBtn = document.getElementById("custom-next-button");
            prevBtn.style.display = "none";
            nextBtn.style.display = "none";
            // custom code to hide arrow of the slider when < 1 slide ends
        }
    }
...
class AccordionDetails extends HTMLDetailsElement {
    ...
    async transition(value) {
        ...
        if (value) {
            ...
            await Motion.timeline([
                [this, {height: [`${this.summaryElement.clientHeight}px`, `${this.scrollHeight}px`]}, {
                    duration: 0.25,
                    easing: 'ease'
                }],
                [this.contentElement, {
            ...
            await Motion.timeline([
                [this.contentElement, {opacity: 0}, {duration: 0.15}],
                [this, {height: [`${this.clientHeight}px`, `${this.summaryElement.clientHeight}px`]}, {
                    duration: 0.25,
                    at: '<',
                    easing: 'ease'
                }]
    ...
    dispatchEventHandler() {
        (this.controlledElement ?? this).dispatchEvent(new CustomEvent('toggle', {
            bubbles: true,
...
class MenuDrawer extends DrawerElement {
    ...
    beforeShow() {
        super.beforeShow();
        setTimeout(() => {
            Motion.animate(this.menuItems, {
                transform: ['translateX(-20px)', 'translateX(0)'],
                opacity: [0, 1]
            }, {duration: 0.6, easing: [.075, .82, .165, 1], delay: Motion.stagger(0.1)}).finished.then(() => {
        ...
        fetch(this.getAttribute('data-url') + this.getQueryString())
            ...
            .then(responseText => {
                ...
                if (recommendations && recommendations.innerHTML.trim().length) {
                    ...
                    // Re-initialize swatch slider after recently view
                    initSwatchSlider();
                } else {
        ...
        fetch(this.getAttribute('data-url'))
            ...
            .then(responseText => {
                ...
                if (recommendations && recommendations.innerHTML.trim().length) {
                    ...
                    // Re-initialize swatch slider after recommended products.
                    initSwatchSlider();
                } else {
...
class MediaElement extends HTMLElement {
    ...
    setupParallax() {
        ...
        if (this.direction === 'vertical') {
            Motion.scroll(
                Motion.animate(this.media, {
                    transform: [`scale(${scale}) translateY(0)`, `scale(${scale}) translateY(${translate}%)`],
            ...
            Motion.scroll(
                Motion.animate(this.media, {
                    transform: [`scale(${scale}) translateX(0)`, `scale(${scale}) translateX(${translate}%)`],
...
class DropdownElement extends HTMLElement {
    ...
    afterShow() {
        Motion.animate(this, {opacity: [0, 1], visibility: 'visible'}, {
            duration: theme.config.motionReduced ? 0 : 0.6,
            easing: [.7, 0, .2, 1]
        });
        Motion.animate(this.container, {transform: ['translateY(-105%)', 'translateY(0)']}, {
            duration: theme.config.motionReduced ? 0 : 0.6,
            easing: [.7, 0, .2, 1]
        });
    }
    ...
    afterHide() {
        Motion.animate(this, {opacity: 0, visibility: 'hidden'}, {
            duration: theme.config.motionReduced ? 0 : 0.3,
            easing: [.7, 0, .2, 1]
        });
        Motion.animate(this.container, {transform: 'translateY(-105%)'}, {
            duration: theme.config.motionReduced ? 0 : 0.6,
            easing: [.7, 0, .2, 1]
        });
    }
...
class DetailsDropdown extends HTMLDetailsElement {
    ...
    async transitionIn() {
        Motion.animate(this.contentElement, {
            opacity: [0, 1],
            visibility: 'visible'
        }, {
            duration: theme.config.motionReduced ? 0 : 0.6,
        ...
        return Motion.animate(this.contentElement.firstElementChild, {transform: [`translateY(${translateY})`, 'translateY(0)']}, {
            duration: theme.config.motionReduced ? 0 : 0.6,
            easing: [.7, 0, .2, 1]
        }).finished;
    }
    ...
    async transitionOut() {
        Motion.animate(this.contentElement, {
            opacity: 0,
            visibility: 'hidden'
        }, {duration: theme.config.motionReduced ? 0 : 0.3, easing: [.7, 0, .2, 1]});
        const translateY = this.level === 'top' ? '-105%' : '2rem';
        return Motion.animate(this.contentElement.firstElementChild, {transform: `translateY(${translateY})`}, {
            duration: theme.config.motionReduced ? 0 : 0.6,
            easing: [.7, 0, .2, 1]
        }).finished;
    }
...
class DetailsMega extends DetailsDropdown {
    ...
    async transitionIn() {
        ...
        return Motion.animate(this.contentElement.firstElementChild, {
            visibility: 'visible',
            transform: ['translateY(-105%)', 'translateY(0)']
        }, {duration: theme.config.motionReduced ? 0 : 0.6, easing: [.7, 0, .2, 1]}).finished;
    }
...
class MotionList extends HTMLElement {
    ...
    async load() {
        ...
        await Motion.animate(visibleItems, {
            y: [distance, 0],
            opacity: [0, 1],
            visibility: ['hidden', 'visible']
        }, {duration: duration, delay: Motion.stagger(staggerDelay)}).finished;
        Motion.animate(inVisibleItems, {
            y: [distance, 0],
            opacity: [0, 1],
            visibility: ['hidden', 'visible']
        }, {duration: duration});
...
class PreviousButton extends HoverButton {
    ...
    onClick() {
        (this.controlledElement ?? this).dispatchEvent(new CustomEvent('slider:previous', {
            bubbles: true,
            cancelable: true
        }));
    }
...
class NextButton extends HoverButton {
    ...
    onClick() {
        (this.controlledElement ?? this).dispatchEvent(new CustomEvent('slider:next', {
            bubbles: true,
            cancelable: true
        }));
    }
...
class ProductStickyForm extends HTMLElement {
    ...
    handleIntersection(entries) {
        ...
        if (this.scopeFromPassed && !this.scopeToReached) {
            Motion.animate(this.firstElementChild, {
                opacity: 1,
                visibility: 'visible',
...
class TabsElement extends HTMLElement {
    ...
    unload() {
        ...
        Motion.animate(fromPanel, {
            transform: ['translateY(0)', 'translateY(2rem)'],
            opacity: [1, 0]
        }, {duration: theme.config.motionReduced ? 0 : 0.15});
    ...
    async transition(fromPanel, toPanel) {
        if (fromPanel) {
            await Motion.animate(fromPanel, {
                transform: ['translateY(0)', 'translateY(2rem)'],
                opacity: [1, 0]
            }, {duration: theme.config.motionReduced ? 0 : 0.15}).finished;
        }
...
class SplittingBanner extends HTMLElement {
    ...
    init() {
        ...
        if (tracker2nd) {
            Motion.scroll(
                Motion.animate(this.querySelector('.button-wrapper'), {
                    opacity: [0, 1, 1],
...
class ProductBundleForm extends HTMLFormElement {
    ...
    onSubmitHandler(event) {
        ...
        this.submitButton.removeAttribute('aria-busy');
        (this.controlledElement ?? this).dispatchEvent(new CustomEvent('bundle:added', {
            bubbles: true,
            detail: {product: product, variant: variant}
        }));
    }
...
class ProductBundleRemoveButton extends HTMLElement {
    constructor() {
        ...
        this.addEventListener('click', (event) => {
            ...
            (this.controlledElement ?? this).dispatchEvent(new CustomEvent('bundle:removed', {
                bubbles: true,
