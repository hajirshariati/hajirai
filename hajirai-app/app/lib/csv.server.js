...
// and CRLF/LF line endings. Returns { headers, rows } where rows are string[].
...
// Parse CSV content and return [{ sku, data }] rows — one per CSV line that has
// a non-empty SKU. `data` is a plain object of { columnName: value }, excluding
// the sku column itself. Returns null if no SKU column could be detected.
