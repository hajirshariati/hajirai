...
(DISCL?'<div class="ai-chat-footer">'+esc(DISCL)+' <a href="'+esc(PRIVURL)+'">Privacy Policy</a><span class="ai-chat-autocorrect-wrap"> · <button type="button" class="ai-chat-autocorrect-toggle" aria-pressed="'+(INPUT_AUTOCORRECT?'true':'false')+'" title="Toggle keyboard autocorrect & spellcheck">Autocorrect: <span class="ai-chat-autocorrect-state">'+(INPUT_AUTOCORRECT?'on':'off')+'</span></button></span></div>':'');
